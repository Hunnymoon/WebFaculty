...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<div class="main" id="Home">
								...
								<ul class="nav navbar-nav navbar-right">
									...
									<div class="navbar-collapse collapse pull-right hidden-xs">
										<li class="fa fa-language">
											<a class="page-scroll"><?=anchor("home/changeEngineering/thailand","Th |");?></a>
											<a class="page-scroll"><?=anchor("home/changeEngineering/english","| En");?></a>
										</li>
									</div>
								</ul>
							</div><!--/.nav-collapse -->
			...
			<?php foreach($academicas as $academic){ 
				if($academic['academic'] == 'Engineering'){ ?>
				<section id="team" class="our-team section-padding blog-wrapper">
					<div class="container">
						<div class="row">
							<div class="wow zoomIn col-xs-12 p-padding">
								<div class="text-center">
									<h1 class="section-title"><?=$this->lang->line("academic");?> <?=$this->lang->line("engineeringAca");?></h1>
								</div>
								<div class="col-md-offset-2">
									<p><?php echo $academic['academicDetail'][$this->session->userdata("lang")];?></p>
								</div>
							</div><!-- col-xs-12 -->
						</div><!-- row -->
						<div class="row">
							<div class="wow zoomIn col-xs-12 text-center p-padding">
								<h1 class="section-title"><?=$this->lang->line("teacher");?></h1>
								<p><?php echo $academic['academicTeacher'][$this->session->userdata("lang")];?></p>
							</div>
						</div><!-- row -->
					</div><!-- container -->
				</section>
			<?php } else if($academic['academic'] == 'Hospitality and Tourism'){ ?>
				<section id="team" class="our-team section-padding blog-wrapper">
					<div class="container">
						<div class="row">
							<div class="wow zoomIn col-xs-12 p-padding">
			...
			<?php } else if($academic['academic'] == 'Business Administration'){ ?>
				<section id="team" class="our-team section-padding blog-wrapper">
					<div class="container">
						<div class="row">
							<div class="wow zoomIn col-xs-12 p-padding">
			...
			<?php } else if($academic['academic'] == 'Certificate Program'){ ?>
				<section id="team" class="our-team section-padding blog-wrapper">
					<div class="container">
						<div class="row">
							<div class="wow zoomIn col-xs-12 p-padding">
								<div class="text-center">
									<h1 class="section-title"><?=$this->lang->line("certificateAca");?></h1>
								</div>
								<div class="col-md-offset-2">
									<p><?php echo $academic['academicDetail'][$this->session->userdata("lang")];?></p>
								</div>
