		...
		<div class="wrapper">
					...
					<div class="navbar-custom-menu">
						<ul class="nav navbar-nav">
							<li class="dropdown messages-menu">
								<?=anchor("admin/changeCertificate/thailand","Th");?>
							</li>
							<li class="dropdown notifications-menu">
								<?=anchor("admin/changeCertificate/english","En");?>
							</li>
						</ul>
					</div>
				</nav>
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					<small><a href="<?php echo base_url(); ?>index.php/admin"><i class="fa fa-home"></i> <?=$this->lang->line("academic");?></a> > <?=$this->lang->line("certificateAca");?></small>
				</section>
				...
				<section class="content">
					...
					<div class="row">
										...
										<form role="form">
											<div class="box-body">
												<?php foreach($certificate as $cer){
													if($cer['academic'] == 'Certificate Program'){ ?>
													<div class="form-group">
														<p><?php echo $cer['academicDetail'][$this->session->userdata("lang")];?></p>
													</div>
											</div>
										</form>
									</div><!-- /.box-body -->
								...
								<div class="box-header">
									<div class="box-body table-responsive no-padding">
										<form role="form">
											<div class="box-body">
												<div class="form-group">
													<p><?php echo $cer['academicTeacher'][$this->session->userdata("lang")];?></p>
												</div>
												<div class="form-group">
						...
						<div class="modal fade" id="editAcademic" role="dialog">
							...
							<?php foreach($certificate as $cer){
								if($cer['academic'] == 'Certificate Program'){ ?>
									<form method="post" action="<?php echo base_url(); ?>index.php/admin/editCertificate/<?php echo $cer['academicId'];?>" enctype="multipart/form-data">
										<div class="modal-content">
											...
											<div class="modal-body">
												<div class="form-group">
													...
													<input type="hidden" name="academicId" value="<?php echo $cer['academicId'];?>">
													<input type="hidden" class="form-control" name="academicDetail[english]" value="<?php echo $cer['academicDetail']['english'];?>">
													<textarea type="text" class="form-control" name="academicDetail[thailand]" id="academicTh" ><?php echo $cer['academicDetail'][$this->session->userdata("lang")];?></textarea>
												</div>
											</div>
											<?php }else{ ?>
											<div class="modal-body">
												<div class="form-group">
													...
													<input type="hidden" name="academicId" value="<?php echo $cer['academicId'];?>">
													<input type="hidden" class="form-control" name="academicDetail[thailand]" value="<?php echo $cer['academicDetail']['thailand'];?>">
													<textarea type="text" class="form-control" name="academicDetail[english]" id="academicEn" ><?php echo $cer['academicDetail'][$this->session->userdata("lang")];?></textarea>
												</div>
											</div>
											<?php } ?>
						...
						<div class="modal fade" id="editTeacher" role="dialog">
							...
							<?php foreach($certificate as $cer){
								if($cer['academic'] == 'Certificate Program'){ ?>
									<form method="post" action="<?php echo base_url(); ?>index.php/admin/editCertificateTeacher/<?php echo $cer['academicId'];?>" enctype="multipart/form-data">
										<div class="modal-content">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal">&times;</button>
											</div>
											...
											<div class="modal-body">
												<div class="form-group">
													<label>อาจารย์</label>
													<input type="hidden" name="academicId" value="<?php echo $cer['academicId'];?>">
													<input type="hidden" class="form-control" name="academicTeacher[english]" value="<?php echo $cer['academicTeacher']['english'];?>">
													<textarea type="text" class="form-control" name="academicTeacher[thailand]" id="teacherTh" ><?php echo $cer['academicTeacher'][$this->session->userdata("lang")];?></textarea>
												</div>
											</div>
											<?php }else{ ?>
											<div class="modal-body">
												<div class="form-group">
													<label>Teacher</label>
													<input type="hidden" name="academicId" value="<?php echo $cer['academicId'];?>">
													<input type="hidden" class="form-control" name="academicTeacher[thailand]" value="<?php echo $cer['academicTeacher']['thailand'];?>">
													<textarea type="text" class="form-control" name="academicTeacher[english]" id="teacherEn" ><?php echo $cer['academicTeacher'][$this->session->userdata("lang")];?></textarea>
												</div>
											</div>
											<?php } ?>
											<div class="modal-footer">
