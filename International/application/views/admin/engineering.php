		...
		<div class="wrapper">
					...
					<div class="navbar-custom-menu">
						<ul class="nav navbar-nav">
							<li class="dropdown messages-menu">
								<?=anchor("admin/changeEngineering/thailand","Th");?>
							</li>
							<li class="dropdown notifications-menu">
								<?=anchor("admin/changeEngineering/english","En");?>
							</li>
						</ul>
					</div>
				</nav>
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					<small><a href="<?php echo base_url(); ?>index.php/admin"><i class="fa fa-home"></i> <?=$this->lang->line("academic");?></a> > <?=$this->lang->line("engineeringAca");?></small>
				</section>
				...
				<section class="content">
					...
					<div class="row">
							...
							<div class="box">
								...
								<div class="box-header">
									<div class="box-body table-responsive no-padding">
										<form role="form">
											<div class="box-body">
												<?php foreach($engineering as $enginess){
													if($enginess['academic'] == 'Engineering'){ ?>
													<div class="form-group">
														<p><?php echo $enginess['academicDetail'][$this->session->userdata("lang")];?></p>
													</div>
											</div>
										</form>
									</div><!-- /.box-body -->
								...
								<div class="box-header">
									<div class="box-body table-responsive no-padding">
										<form role="form">
											<div class="box-body">
												<div class="form-group">
													<p><?php echo $enginess['academicTeacher'][$this->session->userdata("lang")];?></p>
												</div>
												<div class="form-group">
						...
						<div class="modal fade" id="editAcademic" role="dialog">
							...
							<?php foreach($engineering as $enginess){
								if($enginess['academic'] == 'Engineering'){ ?>
									<form method="post" action="<?php echo base_url(); ?>index.php/admin/editEngineering/<?php echo $enginess['academicId'];?>" enctype="multipart/form-data">
										<div class="modal-content">
											...
											<div class="modal-body">
												<div class="form-group">
													...
													<input type="hidden" name="academicId" value="<?php echo $enginess['academicId'];?>">
													<input type="hidden" class="form-control" name="academicDetail[english]" value="<?php echo $enginess['academicDetail']['english'];?>">
													<textarea type="text" class="form-control" name="academicDetail[thailand]" id="academicTh" ><?php echo $enginess['academicDetail'][$this->session->userdata("lang")];?></textarea>
												</div>
											</div>
											<?php }else{ ?>
											<div class="modal-body">
												<div class="form-group">
													...
													<input type="hidden" name="academicId" value="<?php echo $enginess['academicId'];?>">
													<input type="hidden" class="form-control" name="academicDetail[thailand]" value="<?php echo $enginess['academicDetail']['thailand'];?>">
													<textarea type="text" class="form-control" name="academicDetail[english]" id="academicEn" ><?php echo $enginess['academicDetail'][$this->session->userdata("lang")];?></textarea>
												</div>
											</div>
											<?php } ?>
						...
						<div class="modal fade" id="editTeacher" role="dialog">
							...
							<?php foreach($engineering as $enginess){
								if($enginess['academic'] == 'Engineering'){ ?>
									<form method="post" action="<?php echo base_url(); ?>index.php/admin/editEngineeringTeacher/<?php echo $enginess['academicId'];?>" enctype="multipart/form-data">
										<div class="modal-content">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal">&times;</button>
											</div>
											...
											<div class="modal-body">
												<div class="form-group">
													<label>อาจารย์</label>
													<input type="hidden" name="academicId" value="<?php echo $enginess['academicId'];?>">
													<input type="hidden" class="form-control" name="academicTeacher[english]" value="<?php echo $enginess['academicTeacher']['english'];?>">
													<textarea type="text" class="form-control" name="academicTeacher[thailand]" id="teacherTh" ><?php echo $enginess['academicTeacher'][$this->session->userdata("lang")];?></textarea>
												</div>
											</div>
											<?php }else{ ?>
											<div class="modal-body">
												<div class="form-group">
													<label>Teacher</label>
													<input type="hidden" name="academicId" value="<?php echo $enginess['academicId'];?>">
													<input type="hidden" name="academicTeacher[thailand]" value="<?php echo $enginess['academicTeacher']['thailand'];?>" >
													<textarea type="text" class="form-control" name="academicTeacher[english]" id="teacherEn" ><?php echo $enginess['academicTeacher'][$this->session->userdata("lang")];?></textarea>
												</div>
											</div>
											<?php } ?>
											<div class="modal-footer">
