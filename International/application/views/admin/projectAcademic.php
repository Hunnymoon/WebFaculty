		...
		<div class="wrapper">
					...
					<div class="navbar-custom-menu">
						<ul class="nav navbar-nav">
							<li class="dropdown messages-menu">
								<?=anchor("admin/changeProjectAcademic/thailand","Th");?>
							</li>
							<li class="dropdown notifications-menu">
								<?=anchor("admin/changeProjectAcademic/english","En");?>
							</li>
						</ul>
					</div>
				</nav>
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					<small><a href="<?php echo base_url(); ?>index.php/admin"><i class="fa fa-home"></i> <?=$this->lang->line("project");?></a> > <?=$this->lang->line("academicP");?></small>
				</section>
										...
										<table class="table table-hover text-center">
											...
											<?php if([$this->session->userdata("lang")] == ['thailand']){
												...
												if(count($project) == 0 ){
													...
													foreach($project as $art){ 
														if(empty($art['projectName']['english'])) {
															if($art['projectType']['thailand'] == 'บริการวิชาการ'){ ?>
															<tr>
																...
																<td>
																	<a href="<?php echo base_url(); ?>index.php/admin/fromEditProject/<?php echo $art['projectId'];?>" type="button" class="btn btn-info btn-app" data-toggle="modal" data-target="#editProject"><i class="fa fa-edit"></i> Edit</a>
																</td>
																<td>
												...
												if(count($project) == 0 ){
													...
													foreach($project as $art){ 
														if(empty($art['projectName']['thailand'])) {
															if($art['projectType']['english'] == 'Academic Project'){ ?>
															<tr>
																<td><?php echo $art['projectName'][$this->session->userdata("lang")];?> </td>
																<td><?php echo $art['projectTeacher'][$this->session->userdata("lang")];?> </td>
																<td><?php echo $art['projectDate'][$this->session->userdata("lang")];?> </td>
