		...
		<div class="wrapper">
					...
					<div class="navbar-custom-menu">
						<ul class="nav navbar-nav">
							<li class="dropdown messages-menu">
								<?=anchor("admin/changeProjectArt/thailand","Th");?>
							</li>
							<li class="dropdown notifications-menu">
								<?=anchor("admin/changeProjectArt/english","En");?>
							</li>
						</ul>
					</div>
				</nav>
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					<small><a href="<?php echo base_url(); ?>index.php/admin"><i class="fa fa-home"></i> <?=$this->lang->line("project");?></a> > <?=$this->lang->line("artP");?></small>
				</section>
