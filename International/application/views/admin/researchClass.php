		...
		<div class="wrapper">
					...
					<div class="navbar-custom-menu">
						<ul class="nav navbar-nav">
							<li class="dropdown messages-menu">
								<?=anchor("admin/changeResearchClass/thailand","Th");?>
							</li>
							<li class="dropdown notifications-menu">
								<?=anchor("admin/changeResearchClass/english","En");?>
							</li>
						</ul>
					</div>
				</nav>
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					<small><a href="<?php echo base_url(); ?>index.php/admin"><i class="fa fa-home"></i> <?=$this->lang->line("research");?></a> > <?=$this->lang->line("researchClass");?> </small>
				</section>
										...
										<table class="table table-hover text-center">
											...
											<?php if([$this->session->userdata("lang")] == ['thailand']){
												...
												if(count($research) == 0 ){
													...
													foreach($research as $class){ 
														if(empty($class['researchName']['english'])) {
															if($class['researchType']['thailand'] == 'ผลงานวิจัยในชั้นเรียน'){ ?>
															<tr>
																<td><?php echo $class['researchName'][$this->session->userdata("lang")];?> </td>
																<td><?php echo $class['researchTeacher'][$this->session->userdata("lang")];?> </td>
																<td><?php echo $class['researchDate'][$this->session->userdata("lang")];?> </td>
																<td>
																	<a href="<?php echo base_url(); ?>index.php/admin/fromEditResearch/<?php echo $class['researchId'];?>" type="button" class="btn btn-info btn-app" data-toggle="modal" data-target="#editResearch"><i class="fa fa-edit"></i> Edit</a>
																</td>
																<td>
																	<a href="<?php echo base_url(); ?>index.php/admin/delResearch/<?php echo $class['researchId'];?>" type="button" class="btn btn-info btn-app"><i class="fa fa-trash"></i> Delete</a>
																</td>
															</tr>
													 <?php  }  
														}?>
											...
											<?php }else  if([$this->session->userdata("lang")] == ['english']){
												...
												if(count($research) == 0 ){
													...
													foreach($research as $class){ 
														if(empty($class['researchName']['thailand'])) {
															if($class['researchType']['english'] == 'ResearchClass'){ ?>
														<tr>
															<td><?php echo $class['researchName'][$this->session->userdata("lang")];?> </td>
															<td><?php echo $class['researchTeacher'][$this->session->userdata("lang")];?> </td>
															<td><?php echo $class['researchDate'][$this->session->userdata("lang")];?> </td>
