		...
		<div class="wrapper">
					...
					<div class="navbar-custom-menu">
						<ul class="nav navbar-nav">
							<li class="dropdown messages-menu">
								<?=anchor("admin/changeResearchSynthesis/thailand","Th");?>
							</li>
							<li class="dropdown notifications-menu">
								<?=anchor("admin/changeResearchSynthesis/english","En");?>
							</li>
						</ul>
					</div>
				</nav>
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					<small><a href="<?php echo base_url(); ?>index.php/admin"><i class="fa fa-home"></i> <?=$this->lang->line("research");?></a> > <?=$this->lang->line("researchSynthesis");?> </small>
				</section>
						...
						<div class="col-xs-12">
							<div class="box">
								<div class="box-header">
									<h3 class="box-title"><?=$this->lang->line("addResearch");?></h3> 
									...
									<div class="box-body table-responsive no-padding">
										<table class="table table-hover text-center">
											<tr>
												...
												<th><?=$this->lang->line("editResearch");?></th>
											...
											<?php if([$this->session->userdata("lang")] == ['thailand']){
												...
												if(count($research) == 0 ){
													...
													foreach($research as $synthesis){ 
														if(empty($synthesis['researchName']['english'])) {
															if($synthesis['researchType']['thailand'] == 'การสังเคราะห์ผลงานวิจัย'){ ?>
															<tr>
																<td><?php echo $synthesis['researchName'][$this->session->userdata("lang")];?> </td>
																<td><?php echo $synthesis['researchTeacher'][$this->session->userdata("lang")];?> </td>
																<td><?php echo $synthesis['researchDate'][$this->session->userdata("lang")];?> </td>
																<td>
																	<a href="<?php echo base_url(); ?>index.php/admin/fromEditResearch/<?php echo $synthesis['researchId'];?>" type="button" class="btn btn-info btn-app" data-toggle="modal" data-target="#editResearch"><i class="fa fa-edit"></i> Edit</a>
																</td>
																<td>
																<a href="<?php echo base_url(); ?>index.php/admin/delResearch/<?php echo $synthesis['researchId'];?>" type="button" class="btn btn-info btn-app"><i class="fa fa-trash"></i> Delete</a>
															</td>
															</tr>
													 <?php  }  
														}?>
											...
											<?php }else  if([$this->session->userdata("lang")] == ['english']){
												...
												if(count($research) == 0 ){
													...
													foreach($research as $synthesis){ 
														if(empty($synthesis['researchName']['thailand'])) {
															if($synthesis['researchType']['english'] == 'ResearchSynthesis'){ ?>
														<tr>
															<td><?php echo $synthesis['researchName'][$this->session->userdata("lang")];?> </td>
															<td><?php echo $synthesis['researchTeacher'][$this->session->userdata("lang")];?> </td>
															<td><?php echo $synthesis['researchDate'][$this->session->userdata("lang")];?> </td>
				...
				<div class="modal fade" id="addResearch" role="dialog">
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							...
							<form method="post" action="<?php echo base_url(); ?>index.php/admin/addResearch" enctype="multipart/form-data">
								<?php if([$this->session->userdata("lang")] == ['thailand']){ ?>
									<div class="box-body">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="researchTeacher[thailand]" id="researchTeacher" placeholder="<?=$this->lang->line("teacher");?>">
										</div>
										<div class="form-group">
											<label><?=$this->lang->line("nameResearch");?></label>
											<input type="hidden" class="form-control" name="researchName[english]" id="researchName">
											<input type="text" class="form-control" name="researchName[thailand]" id="researchName" placeholder="<?=$this->lang->line("nameResearch");?>">
										</div>
										<div class="form-group">
											<label><?=$this->lang->line("date");?></label>
											<input type="hidden" class="form-control" name="researchDate[english]">
											<input type="text" class="form-control" name="researchDate[thailand]" id="researchDate" placeholder="<?=$this->lang->line("date");?>">
										</div>
										<div class="form-group">
											<div class="radio">
												<label>
									...
									<div class="box-body">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="researchTeacher[english]" id="researchTeacher" placeholder="<?=$this->lang->line("teacher");?>">
										</div>
										<div class="form-group">
											<label><?=$this->lang->line("nameResearch");?></label>
											<input type="hidden" class="form-control" name="researchName[thailand]" id="researchName">
											<input type="text" class="form-control" name="researchName[english]" id="researchName" placeholder="<?=$this->lang->line("nameResearch");?>">
										</div>
										<div class="form-group">
											<label><?=$this->lang->line("date");?></label>
											<input type="hidden" class="form-control" name="researchDate[thailand]">
											<input type="text" class="form-control" name="researchDate[english]" id="researchDate" placeholder="<?=$this->lang->line("date");?>">
										</div>
										<div class="form-group">
											<div class="radio">
												<label>
				...
				<!-- Form editAcademic -->
				<div class="modal fade" id="editResearch" role="dialog">
