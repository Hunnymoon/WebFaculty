	...
	<body>
		...
		<div class="main" id="Home">
			...
			<header  class="header-part">
						...
						<div class="container">
							...
							<div id="navbar" class="navbar-collapse collapse pull-right hidden-xs">
								<ul class="nav navbar-nav navbar-right">
									...
									<li> <a class="page-scroll" href="<?php echo base_url(); ?>index.php#Quality Assurance"><?=$this->lang->line("qa");?></a></li>-->
									<li> <a class="page-scroll" href="<?php echo base_url(); ?>index.php#About"><?=$this->lang->line("about");?></a></li>
									<li> <a class="page-scroll" href="<?php echo base_url(); ?>index.php#Contact"><?=$this->lang->line("contact");?></a></li>
									...
									<div class="navbar-collapse collapse pull-right hidden-xs">
										<li class="fa fa-language">
											<a class="page-scroll"><?=anchor("home/changeNews/thailand","Th |");?></a>
											<a class="page-scroll"><?=anchor("home/changeNews/english","| En");?></a>
										</li>
									</div>
								</ul>
							</div><!--/.nav-collapse -->
				...
				<section class="our-team section-padding blog-wrapper"><!-- blog-content -->
					<div class="container"><!-- container -->
						<div class="row"> <!-- row -->
						<?php foreach($newsFile as $file){ ?>
							<div class="wow zoomIn col-xs-4 "> <!-- col-xs-12 -->
								<img class="img-responsive" src="<?php echo base_url(); ?>upload/news/<?php echo $file['newsfileName'];?>" alt="imageNCU"/>  
							</div> <!-- /.col-xs-12-->
						<?php } ?>
						</div>
						<div class="row">
						<?php foreach($newsDetail as $detail){ ?>
							<div class="wow zoomIn col-xs-2 col-sm-3"><!-- col-md-2 -->
								<div class="blog-date"><!-- blog-date -->
									<p> <?php echo $detail['newsDate'][$this->session->userdata("lang")];?></p>
								</div><!-- /.blog-date -->
							</div><!-- /.col-md-2 -->
							<div class="wow zoomIn col-xs-12 col-sm-9"><!-- col-md-10 -->
								<h1><a><?php echo $detail['newsTitle'][$this->session->userdata("lang")];?></a></h1>
								<p class="contents">
									<?php echo $detail['newsDetail'][$this->session->userdata("lang")];?>
								</p>
							</div><!-- /.col-md-10 -->
						<?php }?>
							<a href="<?php echo base_url(); ?>index.php/home#News"><button class="btn"><li class="fa flaticon-arrowhead9"></li> <?=$this->lang->line("back");?></button></a>
						</div><!--/.row -->
					</div><!-- /.container -->
			...
			<nav id="menu">
				<ul>
					<li> <a><?=anchor("home/changeEngineering/thailand","Thailand");?></a></li>
					<li> <a><?=anchor("home/changeEngineering/english","English");?></a></li>
					<li> <a href="<?php echo base_url(); ?>index.php/home#Home"><?=$this->lang->line("home");?></a></li>
					<li> <a href="<?php echo base_url(); ?>index.php/home#News"><?=$this->lang->line("news");?></a></li>
					<li> <a href="<?php echo base_url(); ?>index.php/home#Academic"><?=$this->lang->line("academic");?></a></li>
					<!--<li> <a href="<?php echo base_url(); ?>index.php/home#Research"><?=$this->lang->line("research");?></a></li>
					<li> <a href="<?php echo base_url(); ?>index.php/home#Project"><?=$this->lang->line("project");?></a></li>
					<li> <a href="<?php echo base_url(); ?>index.php/home#Quality Assurance"><?=$this->lang->line("qa");?></a></li>-->
					<li> <a href="<?php echo base_url(); ?>index.php/home#About"><?=$this->lang->line("about");?></a></li>
