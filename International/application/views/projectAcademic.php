...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<div class="main" id="Home">
								...
								<ul class="nav navbar-nav navbar-right">
									...
									<div class="navbar-collapse collapse pull-right hidden-xs">
										<li class="fa fa-language">
											<a class="page-scroll"><?=anchor("home/changeProjectAcademic/thailand","Th |");?></a>
											<a class="page-scroll"><?=anchor("home/changeProjectAcademic/english","| En");?></a>
										</li>
									</div>
								</ul>
							</div><!--/.nav-collapse -->
					...
					<div class="row">
						<div class="box-body table-responsive no-padding">
							<table class="table table-hover">
								<tr>
									<th><?=$this->lang->line("nameProject");?></th>
									<th><?=$this->lang->line("teacher");?></th>
									<th><?=$this->lang->line("typeProject");?></th>
									<th><?=$this->lang->line("dateResearch");?></th>
									<th><?=$this->lang->line("download");?></th>
								</tr>
								<?php if([$this->session->userdata("lang")] == ['thailand']){
									if(count($projectAcademic) == 0 ){
										echo '<tr><td colspan="5">'.$this->lang->line("nodata").'</td></tr>';
									}else{	
										foreach($projectAcademic as $academic){ 
											if(empty($academic['projectName']['english'])) {
												if($academic['projectType']['thailand'] == 'บริการวิชาการ'){ ?>
													<tr>
														<td><?php echo $academic['projectName'][$this->session->userdata("lang")];?> </td>
														<td><?php echo $academic['projectTeacher'][$this->session->userdata("lang")];?> </td>
														<td><?php echo $academic['projectType'][$this->session->userdata("lang")];?> </td>
														<td><?php echo $academic['projectDate'][$this->session->userdata("lang")];?> </td>
														<td>
															<a href="<?php echo base_url(); ?>index.php/home/dowloadProject/<?php echo $academic['projectfileName'];?>" type="button" class="btn btn-info btn-app"><i class="fa fa-download"></i> Download</a>
														</td>
													</tr>
											<?php } ?>
										<?php }
									...
									if(count($projectAcademic) == 0 ){
										...
										foreach($projectAcademic as $academic){ 
											if(empty($academic['projectName']['thailand'])) {
												if($academic['projectType']['english'] == 'Academic Project'){ ?>
													<tr>
														<td><?php echo $academic['projectName'][$this->session->userdata("lang")];?> </td>
														<td><?php echo $academic['projectTeacher'][$this->session->userdata("lang")];?> </td>
														<td><?php echo $academic['projectType'][$this->session->userdata("lang")];?> </td>
			...
			<nav id="menu">
				<ul>
					<li> <a><?=anchor("home/changeProjectAcademic/thailand","Thailand");?></a></li>
					<li> <a><?=anchor("home/changeProjectAcademic/english","English");?></a></li>
