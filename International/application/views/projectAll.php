...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<div class="main" id="Home">
								...
								<ul class="nav navbar-nav navbar-right">
									...
									<div class="navbar-collapse collapse pull-right hidden-xs">
										<li class="fa fa-language">
											<a class="page-scroll"><?=anchor("home/changeprojectAll/thailand","Th |");?></a>
											<a class="page-scroll"><?=anchor("home/changeprojectAll/english","| En");?></a>
										</li>
									</div>
								</ul>
							</div><!--/.nav-collapse -->
						...
						<div class="box-body table-responsive no-padding">
							<table class="table table-hover">
								...
								<?php if([$this->session->userdata("lang")] == ['thailand']){
									if(count($projectAll) == 0 ){
										echo '<tr><td colspan="5">'.$this->lang->line("nodata").'</td></tr>';
									}else{	
										foreach($projectAll as $all){ 
											if(empty($all['projectName']['english'])) {?>
											<tr>
												<td><?php echo $all['projectName'][$this->session->userdata("lang")];?> </td>
												<td><?php echo $all['projectTeacher'][$this->session->userdata("lang")];?> </td>
												<td><?php echo $all['projectType'][$this->session->userdata("lang")];?> </td>
												<td><?php echo $all['projectDate'][$this->session->userdata("lang")];?> </td>
												<td>
													<a href="<?php echo base_url(); ?>index.php/home/dowloadProject/<?php echo $all['projectfileName'];?>" type="button" class="btn btn-info btn-app"><i class="fa fa-download"></i> Download</a>
												</td>
											</tr>
										<?php }
										} 
									...
									if(count($projectAll) == 0 ){
										...
										foreach($projectAll as $all){ 
											if(empty($all['projectName']['thailand'])) {?>
											<tr>
												<td><?php echo $all['projectName'][$this->session->userdata("lang")];?> </td>
												<td><?php echo $all['projectTeacher'][$this->session->userdata("lang")];?> </td>
												<td><?php echo $all['projectType'][$this->session->userdata("lang")];?> </td>
			...
			<nav id="menu">
				<ul>
					<li> <a><?=anchor("home/changeprojectAll/thailand","Thailand");?></a></li>
					<li> <a><?=anchor("home/changeprojectAll/english","English");?></a></li>
					<li> <a href="<?php echo base_url(); ?>index.php/home#Slide"><?=$this->lang->line("home");?></a></li>
					<li> <a href="<?php echo base_url(); ?>index.php/home#News"><?=$this->lang->line("news");?></a></li>
					<li> <a href="<?php echo base_url(); ?>index.php/home#Academic"><?=$this->lang->line("academic");?></a></li>
					<!--<li> <a href="<?php echo base_url(); ?>index.php/home#Research"><?=$this->lang->line("research");?></a></li>
