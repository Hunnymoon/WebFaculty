...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<div class="main" id="Home">
								...
								<ul class="nav navbar-nav navbar-right">
									...
									<div class="navbar-collapse collapse pull-right hidden-xs">
										<li class="fa fa-language">
											<a class="page-scroll"><?=anchor("home/changeProjectKnowledge/thailand","Th |");?></a>
											<a class="page-scroll"><?=anchor("home/changeProjectKnowledge/english","| En");?></a>
										</li>
									</div>
								</ul>
							</div><!--/.nav-collapse -->
						...
						<div class="box-body table-responsive no-padding">
							<table class="table table-hover">
								...
								<?php if([$this->session->userdata("lang")] == ['thailand']){
									if(count($projectKnowledge) == 0 ){
										echo '<tr><td colspan="5">'.$this->lang->line("nodata").'</td></tr>';
									}else{	
										foreach($projectKnowledge as $knowledge){ 
											if(empty($knowledge['projectName']['english'])) {
												if($knowledge['projectType']['thailand'] == 'การจัดการความรู้'){ ?>
													<tr>
														...
														<td><?php echo $knowledge['projectType'][$this->session->userdata("lang")];?> </td>
														<td><?php echo $knowledge['projectDate'][$this->session->userdata("lang")];?> </td>
														<td>
															<a href="<?php echo base_url(); ?>index.php/home/dowloadProject/<?php echo $knowledge['projectfileName'];?>" type="button" class="btn btn-info btn-app"><i class="fa fa-download"></i> Download</a>
														</td>
													</tr>
											<?php } ?>
										<?php }
			...
			<nav id="menu">
				<ul>
					<li> <a><?=anchor("home/changeProjectKnowledge/thailand","Thailand");?></a></li>
					<li> <a><?=anchor("home/changeProjectKnowledge/english","English");?></a></li>
					<li> <a href="<?php echo base_url(); ?>index.php/home#Slide"><?=$this->lang->line("home");?></a></li>
					<li> <a href="<?php echo base_url(); ?>index.php/home#News"><?=$this->lang->line("news");?></a></li>
					<li> <a href="<?php echo base_url(); ?>index.php/home#Academic"><?=$this->lang->line("academic");?></a></li>
					<!--<li> <a href="<?php echo base_url(); ?>index.php/home#Research"><?=$this->lang->line("research");?></a></li>
