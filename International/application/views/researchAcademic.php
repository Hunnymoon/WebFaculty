...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<div class="main" id="Home">
								...
								<ul class="nav navbar-nav navbar-right">
									...
									<div class="navbar-collapse collapse pull-right hidden-xs">
										<li class="fa fa-language">
											<a class="page-scroll"><?=anchor("home/changeResearchAcademic/thailand","Th |");?></a>
											<a class="page-scroll"><?=anchor("home/changeResearchAcademic/english","| En");?></a>
										</li>
									</div>
								</ul>
							</div><!--/.nav-collapse -->
						...
						<div class="box-body table-responsive no-padding">
							<table class="table table-hover">
								...
								<?php if([$this->session->userdata("lang")] == ['thailand']){
									if(count($researchAcademic) == 0 ){
										echo '<tr><td colspan="5">'.$this->lang->line("nodata").'</td></tr>';
									}else{	
										foreach($researchAcademic as $academic){ 
											if(empty($academic['researchName']['english'])) {
												if($academic['researchType']['thailand'] == "ผลงานวิชาการ"){ ?>
													<tr>
														...
														<td><?php echo $academic['researchType'][$this->session->userdata("lang")];?> </td>
														<td><?php echo $academic['researchDate'][$this->session->userdata("lang")];?> </td>
														<td>
															<a href="<?php echo base_url(); ?>index.php/home/dowloadResearch/<?php echo $academic['researchflieName'];?>" type="button" class="btn btn-info btn-app"><i class="fa fa-download"></i> Download</a>
														</td>
													</tr>
											<?php } ?>
										<?php }
			...
			<nav id="menu">
				<ul>
					<li> <a><?=anchor("home/changeResearchAcademic/thailand","Thailand");?></a></li>
					<li> <a><?=anchor("home/changeResearchAcademic/english","English");?></a></li>
