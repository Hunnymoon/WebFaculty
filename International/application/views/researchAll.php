...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<div class="main" id="Home">
								...
								<ul class="nav navbar-nav navbar-right">
									...
									<div class="navbar-collapse collapse pull-right hidden-xs">
										<li class="fa fa-language">
											<a class="page-scroll"><?=anchor("home/changeResearchAll/thailand","Th |");?></a>
											<a class="page-scroll"><?=anchor("home/changeResearchAll/english","| En");?></a>
										</li>
									</div>
								</ul>
							</div><!--/.nav-collapse -->
						...
						<div class="box-body table-responsive no-padding">
							<table class="table table-hover">
								...
								<?php if([$this->session->userdata("lang")] == ['thailand']){
									if(count($researchAll) == 0 ){
										echo '<tr><td colspan="5">'.$this->lang->line("nodata").'</td></tr>';
									}else{	
										foreach($researchAll as $all){ 
											if(empty($all['researchName']['english'])) {?>
											<tr>
												<td><?php echo $all['researchName'][$this->session->userdata("lang")];?> </td>
												<td><?php echo $all['researchTeacher'][$this->session->userdata("lang")];?> </td>
												<td><?php echo $all['researchType'][$this->session->userdata("lang")];?> </td>
												<td><?php echo $all['researchDate'][$this->session->userdata("lang")];?> </td>
												<td>
													<a href="<?php echo base_url(); ?>index.php/home/dowloadResearch/<?php echo $all['researchflieName'];?>" type="button" class="btn btn-info btn-app"><i class="fa fa-download"></i> Download</a>
												</td>
											</tr>
										<?php }
										} 
									...
									if(count($researchAll) == 0 ){
										...
										foreach($researchAll as $all){ 
											if(empty($all['researchName']['thailand'])) {?>
											<tr>
												<td><?php echo $all['researchName'][$this->session->userdata("lang")];?> </td>
												<td><?php echo $all['researchTeacher'][$this->session->userdata("lang")];?> </td>
												<td><?php echo $all['researchType'][$this->session->userdata("lang")];?> </td>
			...
			<nav id="menu">
				<ul>
					<li> <a><?=anchor("home/changeResearchAll/thailand","Thailand");?></a></li>
					<li> <a><?=anchor("home/changeResearchAll/english","English");?></a></li>
