...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<div class="main" id="Home">
								...
								<ul class="nav navbar-nav navbar-right">
									...
									<div class="navbar-collapse collapse pull-right hidden-xs">
										<li class="fa fa-language">
											<a class="page-scroll"><?=anchor("home/changeResearchSynthesis/thailand","Th |");?></a>
											<a class="page-scroll"><?=anchor("home/changeResearchSynthesis/english","| En");?></a>
										</li>
									</div>
								</ul>
							</div><!--/.nav-collapse -->
						...
						<div class="box-body table-responsive no-padding">
							<table class="table table-hover">
								...
								<?php if([$this->session->userdata("lang")] == ['thailand']){
									if(count($researchSynthesis) == 0 ){
										echo '<tr><td colspan="5">'.$this->lang->line("nodata").'</td></tr>';
									}else{	
										foreach($researchSynthesis as $synthesis){ 
											if(empty($synthesis['researchName']['english'])) {
												if($synthesis['researchType']['thailand'] == 'การสังเคราะห์ผลงานวิจัย'){ ?>
													<tr>
														...
														<td><?php echo $synthesis['researchType'][$this->session->userdata("lang")];?> </td>
														<td><?php echo $synthesis['researchDate'][$this->session->userdata("lang")];?> </td>
														<td>
															<a href="<?php echo base_url(); ?>index.php/home/dowloadResearch/<?php echo $synthesis['researchflieName'];?>" type="button" class="btn btn-info btn-app"><i class="fa fa-download"></i> Download</a>
														</td>
													</tr>
											<?php } ?>
										<?php }
			...
			<nav id="menu">
				<ul>
					<li> <a><?=anchor("home/changeResearchSynthesis/thailand","Thailand");?></a></li>
					<li> <a><?=anchor("home/changeResearchSynthesis/english","English");?></a></li>
					<li> <a href="<?php echo base_url(); ?>index.php/home#Slide"><?=$this->lang->line("home");?></a></li>
					<li> <a href="<?php echo base_url(); ?>index.php/home#News"><?=$this->lang->line("news");?></a></li>
					<li> <a href="<?php echo base_url(); ?>index.php/home#Academic"><?=$this->lang->line("academic");?></a></li>
					<!--<li> <a href="<?php echo base_url(); ?>index.php/home#Research"><?=$this->lang->line("research");?></a></li>
